	...
	<div class="main row mt-4">
		...
		<div class="manager">
			<div class="w-100 d-flex justify-content-between align-items-center py-4">
				...
				<div>
					<button class="button btn btn-user-add text-white btn-primary" onclick="clickButtonToOn()">
						Add new category
					</button>
				</div>
			</div>
		...
		<div class="form-edit" action="./edit.php">
...
<script>
	...
	const btnCloseForm = document.querySelector(".btn_close_form")
