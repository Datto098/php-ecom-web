			...
			<div class="w-100 d-flex justify-content-between align-items-center py-4">
				<form class="search" action="FindCategory" method="get">
					<div class="row py-1 px-1">
						<div class="col-10">
							<input type="text" name="name" id="search" placeholder="Search" class="border-0 form-control" />
						</div>
						<div class="col-2">
				...
				<div>
					<button class="button btn btn-user-add" style="background-color: #9055fd" onclick="clickButtonToOn()">
						Add Accout
					</button>
				</div>
			</div>
		...
		<table class="w-100">
			...
			<tbody>
				<tr>
					...
					<td>
						<div class="">
							<a class="btn btn-primary me-3" href="edit.php">Edit</a>
							<a class="btn btn-danger" href="DeleteCategory?id=" onclick="return deleteCommit();">Delete</a>
							<a class="btn btn-danger" href="DeleteCategory?id=" onclick="return deleteCommit();">Details</a>
						</div>
					</td>
				</tr>
			</tbody>
