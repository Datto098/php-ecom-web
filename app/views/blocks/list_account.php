	...
	<div class="main row mt-4">
		<div class="manager">
			<div class="w-100 d-flex justify-content-between align-items-center py-4">
				...
				<div>
					<a class="button btn btn-user-add" style="background-color: #9055fd" onclick="clickButtonToOn()" href="create.php">Add Accout</a>
				</div>
			</div>
		</div>
					...
					<tr>
						...
						<td>
							<div class="d-flex" style="justify-content: space-between">
								...
								<a class="btn btn-danger" href="destroy.php?id=<?php echo $user['id'] ?>" onclick="return deleteCommit();">Delete</a>
								<a class="btn btn-secondary" href="show.php?id=<?php echo $user['id'] ?>">Details</a>
							</div>
						</td>
					</tr>
