...
<section class="product spad">
    <div class="container">
        ...
        <div class="row product__filter">
            ...
            <?php
            if (isset($product_sale_data)) {
                foreach ($product_sale_data as $key => $product_sale) { ?>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="public/uploads/<?= $product_sale['product_img'] ?>">
                                <ul class="product__hover">
                                    <li>
                            ...
                            <div class="product__item__text">
                                <h6><?= $product_sale["product_name"] ?></h6>
                                <a href="#" class="add-cart">+ Add To Cart</a>
                                <?php
                                $averageRate = $product_sale["rates"]["average_rate"];
                                ...
                                ?>
                                <div class="">
                                    <h5><?= number_format($product_sale['product_price'] - ($product_sale['product_price'] * $product_sale["sale_percent"] / 100), 0, ',', '.') . "đ" ?></h5>
                                    <p style="text-decoration: line-through;"><?= number_format($product_sale['product_price'], 0, ',', '.') . "đ" ?></p>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="blog__item">
                    ...
                    <div class="blog__item__text">
                        <span><img src="public/img/icon/calendar.png" alt="" /> 16 February
                            2020</span>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="blog__item">
                    ...
                    <div class="blog__item__text">
                        <span><img src="public/img/icon/calendar.png" alt="" /> 21 February
                            2020</span>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="blog__item">
                    ...
                    <div class="blog__item__text">
                        <span><img src="public/img/icon/calendar.png" alt="" /> 28 February
                            2020</span>
